...
export const metadata: Metadata = {
  title: "Premium Tea Collection | Black & Green Teas | TeaBliss",
  description: "Discover the finest black and green teas from around the world. Premium, organic, ethically sourced teas delivered fresh to your door.",
  keywords: "premium tea, black tea, green tea, organic tea, loose leaf tea, tea collection, artisan tea",
  metadataBase: new URL("https://teabliss.com"),
  alternates: {
    canonical: "https://teabliss.com"
  },
  openGraph: {
    title: "Premium Tea Collection | TeaBliss",
    description: "Discover the finest black and green teas from around the world. Premium, organic, ethically sourced teas delivered fresh.",
    url: "https://teabliss.com",
    siteName: "TeaBliss",
    images: [
      {
        url: "https://images.pexels.com/photos/7368108/pexels-photo-7368108.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
        alt: "Premium tea ceremony with loose leaf teas"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "Premium Tea Collection | TeaBliss",
    description: "Discover the finest black and green teas from around the world. Premium, organic, ethically sourced teas delivered fresh.",
    images: ["https://images.pexels.com/photos/7368108/pexels-photo-7368108.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
